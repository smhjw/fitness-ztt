    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "inset-x-0 bottom-0 top-auto translate-x-0 translate-y-0 rounded-t-2xl border-t",
          "sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:rounded-lg sm:border",
          className
        )}
        {...props}
      >
