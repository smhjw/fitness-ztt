  ...
  const features = [
    {
      ...
      title: '记录运动',
      description: '轻松记录每次运动详情',
    },
    {
      icon: <TrendingUp className="w-5 h-5" />,
      title: '追踪进度',
      description: '可视化你的运动数据',
    },
    {
      icon: <Calendar className="w-5 h-5" />,
      title: '日历视图',
      description: '一目了然运动安排',
    },
    {
      icon: <BookOpen className="w-5 h-5" />,
      title: '健身知识',
      description: '专业健身指导内容',
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#333333] leading-tight">
              追踪你的
              <span className="text-gradient"> 健身日常</span>
            </h1>

            <p className="text-lg text-[#718096] max-w-lg">
              记录运动，追踪趋势，保持动力。FitTrack 帮助你建立健康的运动习惯，实现健身目标。
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 p-4 rounded-xl bg-white/80 backdrop-blur-sm shadow-card hover:shadow-card-hover transition-shadow"
                >
                  <div className="w-10 h-10 rounded-lg bg-[#E6F7F6] text-[#38B2AC] flex items-center justify-center flex-shrink-0">
                    {feature.icon}
                  </div>
                  <div>
                ...
                <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
                  ...
                  <div className="h-full bg-[#F5F7FA]">
                    ...
                    <div className="bg-[#38B2AC] p-6 pb-12">
                      ...
                      <p className="text-white/80 text-sm">今日运动</p>
                    ...
                    <div className="px-4 -mt-6">
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-white p-4 rounded-xl shadow-card">
                          <p className="text-[#718096] text-xs">本周运动</p>
                          <p className="text-[#333333] text-xl font-bold">5 次</p>
                        </div>
                        <div className="bg-white p-4 rounded-xl shadow-card">
                          <p className="text-[#718096] text-xs">连续打卡</p>
                          <p className="text-[#333333] text-xl font-bold">12 天</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 mt-4">
                      <p className="text-[#333333] font-medium mb-3">最近记录</p>
